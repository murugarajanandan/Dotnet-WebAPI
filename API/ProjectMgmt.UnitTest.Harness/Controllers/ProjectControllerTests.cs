...
namespace ProjectMgmt.UnitTest.Harness
{
    ...
    public class ProjectControllerTests
    {
        ...
        {
            var result = controller.CreateProject(new ProjectDBModel { ProjectID = 1, ProjectTitle = "ServiceFund", Priority = 1 });
            Assert.IsNotNull(result);
        }
        ...
        {
            var result = controller.UpdateProject(new Project { ProjectID = 1, ProjectTitle = "ServiceFund", Priority = 2 });
            Assert.IsNotNull(result);
        }
    }
}